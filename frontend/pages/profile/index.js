                    ...
                    <Container className="">
                        <div className="mv_user-email">
                            <Fieldset className="mb-6">
                                <Fieldset.Content>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Fieldset.Subtitle>
                                                Click on the avatar to upload a
                                ...
                                <Fieldset.Footer className="flex justify-between items-center">
                                    <Text>
                                        An avatar is optional but strongly
                                        recommended.
                                    </Text>
                                    <Button
                                        className="font-bold"
                        ...
                        <div className="mv_username">
                            <Fieldset className="mb-6">
                                ...
                                <Input
                                    label="username"
                                    placeholder={textToUrl(user.displayName)}
                                />
                        ...
                        <div className="mv_user-email">
                            <Fieldset className="mb-6">
                                ...
                                <Fieldset.Subtitle>
                                    Please enter the email address you want to
                                    use to log in with Miah vai.
                                </Fieldset.Subtitle>
                        ...
                        <div className="mv_user-id">
                            <Fieldset className="mb-6">
                                ...
                                <Fieldset.Footer className="">
                                    <Text>
                                        Used when interacting with the Vercel
                                        API.
                                    </Text>
                                </Fieldset.Footer>
                            </Fieldset>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Fieldset.Subtitle my="12px">
                                        ...
                                        and all of its contents from the Miah
                                        Vai platform. This action is not
